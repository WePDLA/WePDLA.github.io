...
{% include figure.html  height="652" width="488" src="/figures/2021-09-29-TEXT2EVENT Controllable Sequence-to-Structure Generation for End-to-end Event Extraction/event record format.png" caption="图1：event record format.png"%}
