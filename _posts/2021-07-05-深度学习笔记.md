...
{% include figure.html  width="488" src="/figures/20210721-DL/bp.jpg" caption="图：Forward and Backward"%}
...
优化目标函数：$$ L $$，
更新参数：$$ w = w - \eta*\partial L/ \partial w$$

改变为：
优化目标函数：$$ L' = L + 0.5*\lambda*\|w\|_2$$，
更新参数：$$ w = w - \eta*\partial L/ \partial w -\eta*\lambda*w$$
...
例如，取动量 $$\triangle w = -\partial L/ \partial w$$。
