...
* 挑战3、怎么训练才能有效：在PipeDream的图中可以看出在minibatch 5计算forward是在minibatch 1的backward结束之后开始计算的，5的backward计算则需要2、3、4的backward结束之后才开始，所以<font color=blue>5在stage 1计算梯度是和forward过程完全不一样的权重</font>，这种差异可能导致训练不收敛.
  ...
  {% include figure.html src="/figures/PP-papers/weightstashing.png" caption="图3：Pipedream中的weightstashing。"%}
=======
...
* 冗余的计算
<<<<<<< HEAD
{% include figure.html src="/figures/PP-papers/dapple.png" caption="图4：Dapple。"%}
=======
...
=======
{% include figure.html  height="652" width="488" src="/figures/PP-papers/xpipe.png" caption="图6：Xpipe。"%}
>>>>>>> ee0758c7cf34333963091fa9a5e1845eb8f76ba5
...
=======
{% include figure.html  height="652" width="488" src="/figures/PP-papers/weight_diff.png" caption="图7：weight difference的计算。"%}
>>>>>>> ee0758c7cf34333963091fa9a5e1845eb8f76ba5
