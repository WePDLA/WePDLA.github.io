...
\begin{equation}
\text{argmax}_{\mu \in (-\infty, +\infty)} \log P(\mathcal O | \mathcal P) P(\mathcal P).\tag{1}
\end{equation}
...
\begin{equation}
y^{k+1} = sign \left(x^{k+1}+\frac{\mu \lambda^k}{\beta} \right) \bullet \max \left( x^{k+1} + \frac{\mu \lambda^k}{\beta} -  \frac{\mu}{\beta}, 0  \right).
\end{equation}
