...
{% include figure.html src="/figures/2021-10-28-prompt/4 paradigms.png" caption="图1：数据生成流程示意"%}
...
{% include figure.html src="/figures/2021-10-28-prompt/prompt basic.png" caption="图2：prompt的一些术语"%}
...
{% include figure.html src="/figures/2021-10-28-prompt/examples of prompt.png" caption="图2：prompt在一些任务上的使用示例"%}
